...
public class TC_homepage_01 extends BasePage{
	@Test
	public void sortingitemslowtohigh() {
		...
		hp.selectdd("Price (low to high)");//sorting using dropdown price from low to high Ascending order
